...
<a class="navbar-brand" href="buy.php"><img src="falogo.png"></a>
...
<a class="dropdown-item" href="formlog.php"> Login</a>
<a class="dropdown-item" href="formlog.php">Sign-Up</a>
</div>
</li>
<li class="nav-item dropdown">
...
<a class="nav-link" href="EyAuctions.php" style="color:#964B00;" onMouseOver="this.style.color='#1FF026'" onMouseOut="this.style.color='#964B00'">Home <span class="sr-only">(current)</span></a>
</li>-->
<li class="nav-item">
</ul>
</div>
...
<div style="position:absolute;top:55%;bottom:45%;left:10%;opacity:0.9;">
<a href="formlog.php" ><button class="button" style="width:300px;height:50px;"><span>TUTORIALS/MAINTENANCE RECORDS</span></button></a>
<a href="buyfarm.php" ><button class="button" style="width:300px;height:50px;"><span>BUY CROPS</span></button></a>
<a href="formlog.php" ><button class="button" style="width:300px;height:50px;"><span>SELL CROPS</span></button></a>
<a href="#" ><button class="button" style="width:300px;height:50px;"><span>WEATHER REPORTS</span></button></a>
</div>
