...
<hr class=" mx-auto w-25 animated zoomIn" style="border: 0;height: 1px;background-image: linear-gradient(to right, rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0));">
 ...
 <div class = "vertical animated zoomIn"></div>
		 ...
		 <h4 class="animated bounceInRight text-center" style="font-family: 'Libre Baskerville', serif;">Your Post's</h4>
		 <hr class=" mx-auto w-25 animated zoomIn" style="border: 0;height: 1px;background-image: linear-gradient(to right, rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0));">
...
<?php
  ...
  $con =mysqli_connect('localhost','root');
  mysqli_select_db($con,'userregistration');
  $q="select product_name,category,price,img,date,description,product_id from products where name='$na' ";
...
var x = setInterval(function() {
  ...
  <p class="card-text" ><?php echo "Start Price : ".$rs['price'];?></p>
    ...
    <a href="Subpage.php"><button class="button" ><span>View Product</span></button></a>
  ...
  <footer class="abt container-fluid fixed-bottom" >
    <div class="row">
