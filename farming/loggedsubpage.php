...
<header>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
      <li class="nav-item">
        <a class="nav-link" href="formlog.php">Logout</a>
      </li>
      <li class="nav-item dropdown">
        ...
        <a class="nav-link" href="formlog.php" target="_blank" tabindex="-1" aria-disabled="true">Sell Product</a>
...
<section >
		 ...
		 <div class="text-center col-lg-12 col-md-12 col-col-12 ">
		 <h4 class="animated bounceInRight text-center pt-3" style="font-family: 'Libre Baskerville', serif;"> Iphone</h4>
...
<div class="  row text-center pt-3"> 
  <div class="a col-lg-12 col-md-12 col-12 " style="height:800px;width:1200px;" > 
  <div class="card" >
  <div class="  row text-center pt-3">
  <div class=" col-lg-4 col-md-4 col-12 " > 
  <img class="card-img-top pt-5 pb-5" src="iphone.jpg" height=500 width=400 alt="Card image" >
</div>
<div class=" col-lg-4 col-md-4 col-12 " style="position:absolute;top:100px;right:10px;" > 
    
    <h4 class="pt-3" >Apple iPhone 7 (Black, 32 GB)</h4>
        <hr class=" mx-auto w-25 animated zoomIn" style="border: 0;height: 1px;background-image: linear-gradient(to right, rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0));">
    <h4 style="color:green;">Extra ₹2901 discount</h4>
   <h3 class="">₹26,999</h3>
</div>

</div>
  <div class="card-body" style="background: linear-gradient(110deg, #D7BDE2 50%,#e0d6ff 70%);">
...
var x = setInterval(function() {
  ...
  if (distance < 0) {
    ...
    <a href="#" ><button class="button"><span>Place Bid</span></button></a>
  </div>
</div>
 </div>
